...
class TestIssues:
    ...
    def test_list_issues(self, mock_client):
        ...
        mock_client._get.assert_called_with("/repos/owner/repo/issues", params={})
    ...
    def test_get_issue(self, mock_client):
        ...
        mock_client._get.assert_called_with("/repos/owner/repo/issues/123")
    ...
    def test_create_issue(self, mock_client):
        ...
        mock_client._post.assert_called_with(
            "/repos/owner/repo/issues", json={"title": "title", "body": "body"}
        )
